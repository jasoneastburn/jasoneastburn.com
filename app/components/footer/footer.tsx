...
const quoteFont = localFont({ src: '../../../public/sometimes.ttf' });
...
export function Footer() {
  ...
  return (
    <footer className='absolute bottom-0 w-full'>
      ...
      <div
        className={`${quoteFont.className} bg-primary text-accent text-center text-7xl`}
      >
        &quot;The best preparation for tomorrow is doing your best today.&quot;
      </div>
      <div className='bg-primary text-accent text-center pt-2 pb-5'>
        ― H. Jackson Brown, Jr.
      </div>
      <div className='bg-primary text-accent text-center py-5'>
        © {copyrightYear} Jason Eastburn
      </div>
    </footer>
  );
}
