...
function PostHeader({ content }: { content: CoreContent<Blog> }) {
...
function PostSidebar({ content }: { content: CoreContent<Blog> }) {
  const { slug, toc, type } = content
  return (
    <div className="hidden lg:sticky lg:top-28 lg:col-span-4 lg:block xl:col-span-3">
